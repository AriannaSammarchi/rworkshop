...
[R Studio Mac OS Installers](https://cran.r-project.org/bin/macosx/big-sur-arm64/base/R-4.2.2-arm64.pkg)
...
Click the icon for R studio ![](rworkshop/figures/Rstudio.png){width="95" height="34"}.

You should see something like the figure below:

![](rworkshop/figures/rstudio_1.png)
...
![Creative Commons 4](rworkshop/figures/cc.png) How I Learned to Stop Worrying and Love the R Console by [Irfan E Kanat](http://irfankanat.com) is licensed under a [Creative Commons Attribution 4.0 International License](http://creativecommons.org/licenses/by/4.0/). Based on a work at <http://github.com/iekanat/rworkshop>.
